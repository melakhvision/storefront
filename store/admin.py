...
class ProductAdmin(admin.ModelAdmin):
    # auto complete fields | add collection in search field in CollectionAdmin
    ...
    # Create custom string to display here we create inventory_status
    ...
    def clear_inventory(self, request, queryset: QuerySet):
        ...
        self.message_user(
            request,
            f'{updated_count} was successfully updated',
            messages.ERROR
        )
